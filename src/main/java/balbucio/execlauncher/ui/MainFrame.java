...
import balbucio.execlauncher.components.ExecutableCellRenderer;
...
public class MainFrame extends JFrame {
    ...
    public JPanel getActions() {
...

        {
            ...
            button.addActionListener(e -> new CreateOrUpdateExecutable());
            panel.add(button);
        }
    ...
    public void update() {
        listPanel.removeAll();
        for (Executable executable : main.getStorage().executables()) {
